    ...
    <div className="py-8">
      <div className="container">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {/* first col */}
          <div className="py-10 pl-5 bg-gradient-to-br from-brandBlue/70 to-brandBlue text-white rounded-3xl relative h-[320px] flex items-end">
          ...
          {/* second col */}
          <div className="py-10 pl-5 bg-gradient-to-br from-brandYellow/60 to-brandYellow text-white rounded-3xl relative h-[320px] flex items-end">
            <div className="relative z-10">
              <div className="mb-4">
                <p className="mb-[2px] text-gray-100">Jenis</p>
                <p className="text-2xl font-semibold mb-[2px] opacity-80">
